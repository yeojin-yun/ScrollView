...
//    let coll = ScrollCollectionViewController(collectionViewLayout: UICollectionViewFlowLayout())

    override func viewDidLoad() {
        super.viewDidLoad()
//        let layout = UICollectionViewFlowLayout()
//        let collectionView = ScrollCollectionViewController(collectionViewLayout: layout)
...
extension ScrollCollectionViewController {
    func setLayout() {
//        let layout = UICollectionViewFlowLayout()
